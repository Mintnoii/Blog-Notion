...
export const CodeBlock = ({ code, language, metastring }: Props) => {
  ...
  //       viewBox="0 0 32 32"
  //       fill="none"
  //       className="stroke-current transform transition group-hover:rotate-[-4deg]"
  //     >
  //       <path
  ...
  // )
  return (
    <div className="rounded-md bg-zinc-900 bg-opacity-60 text-sm overflow-auto dark:bg-zinc-800">
      <div className="border-b flex flex-row  border-gray-300 mb-1 items-center justify-between dark:border-gray-700 ">
        {/* {CopyCodeButton} */}
        <div className="mr-2 text-xs p-1 text-gray-400 ">{language}</div>
      </div>
